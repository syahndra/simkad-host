@extends('layouts.app', ['title' => 'Form Tambah Operator Kecamatan', 'menu' => 'user'])
@section('content')
        ...
        <div class="container-fluid">
            ...
            <div class="title-wrapper pt-30">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <div class="title">
                            <h2>Form Tambah Operator Kecamatan</h2>
                        </div>
                    </div>
                    <!-- end col -->
                    <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card-style mb-30" style="min-height: 650px; overflow: auto;">
                            ...
                            @endif
                            <form action="{{ route('operatorKec.store') }}" method="POST">
                                @csrf
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="idKec" class="form-control" required>
                                        <option value="" disabled {{ old('idKec') ? '' : 'selected' }}>-- Pilih
                                            Kecamatan --</option>
